    ...
    public class LivroController : Controller
    {
        ...
        public IActionResult ImagemCapa(int id)
        {
            ...
            return File("~/images/capas/capa-vazia.png", "image/png");
                ...
                // Entrega de resposta com um objeto independente do .Net
        public Livro RecuperaLivro(int id) {
            return _repo.Find(id);
        }

                // Entrega de resposta com View - HTML
        [HttpGet]
        public IActionResult Detalhes(int id)
        {
            ...
            return View(model.ToModel());
                ...
                // Entrega de resposta com qualquer tipo
        public ActionResult<LivroUpload> DetalhesQualquerTipo(int id) {
            var model = RecuperaLivro(id);
            if (model == null) {
                return NotFound();
            }
